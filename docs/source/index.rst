...
Если у вас возникли вопросы по установке Compose, то вы можете обратиться к инструкции на `сайте разработчика  <https://docs.docker.com/compose/install/linux/>`_
