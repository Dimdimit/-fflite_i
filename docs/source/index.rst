...
Шаг 1: Удаляем ранее установленную версию Docker: сервисы``docker``, ``docker.io,`` или ``docker-engine`` должны быть удалены:
...
Шаг 2: Установка Docker из репозитория.
...
*Обновляем индексацию apt-пакетов и устанавливаем пакеты, позволяющие использовать  пакеты apt через HTTPS:
