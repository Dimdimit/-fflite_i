...
FF.Lite выпускается в двух версиях GPU и CPU. Про отличия данных версий рассказывается в первой части `О Системе`. Для установки на потребуется только один файл.
...
Далее необходимо использовать `файл инсталлятора FF.Lite`_ 
