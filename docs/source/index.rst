...
Если вы не знакомы с операционной системой Linux, то вам необходимо обратиться за помощью к специалисту, разбирающегося в установке и настройке программного обеспечения на Linux (Ubuntu).
...
И так, вы знакомы с Linux и на уровне пользователя, тогда приступаем:
...
И далее продолжить установку, как описано в следующем разделе `Установка FF.Lite`_
